...
import CosbtcHelloCosbtcHelloHello from './cosbtc/hello/cosbtc.hello.hello'
...
export default { 
  CosbtcHelloCosbtcHelloHello: load(CosbtcHelloCosbtcHelloHello, 'cosbtc.hello.hello'),
